...
class UnitsController extends Controller
{
    ...
    public function data(Request $request)
    {
        ...
        ->addColumn('from_to', function ($units) {
            return __('base.units.from_to', ['from' => $units->from, 'to' => $units->to]) ?? '';
        })
        ...
        ->addColumn('actions', function($units) use($request){
            ...
            if($units->trashed()) {
                $actions[] = [
                    ...
                    'type'          => 'icon',
                    'link'          => route('units::restore', ['id' => $units->id ]),
                    'method'        => 'POST',
                ...
                $actions[] = [
                    ...
                    'type'          => 'icon',
                    'link'          => route('units::delete', ['id' => $units->id ]),
                    'method'        => 'POST',
                ...
                $actions[] = [
                    ...
                    'type'          => 'icon',
                    'link'          => route('units::soft_delete', ['id' => $units->id ]),
                    'method'        => 'POST',
                ...
                $actions[] = [
                    ...
                    'type'          => 'icon',
                    'link'          => route('units::edit', ['id' => $units->id ]),
                    'method'        => 'GET',
    ...
    public function create(Request $request)
    {
        ...
        return view('backend.units.create', ['users' => $users, 'categories' => $categories ]);
    }
    ...
    public function show(Request $request, $id)
    {
        ...
        $units      = units::find($id);
        $categories = Categories::get();
        return view('backend.units.update', ['data' => $units, 'users' => $users , 'categories' => $categories ]);
    }
